...
def upgrade():
    op.add_column('snapshot', sa.Column('anonymous', sa.Boolean(), nullable=False, server_default=sa.false()))
    op.alter_column('snapshot', 'anonymous', server_default=None)
    op.add_column('snapshot', sa.Column('score', sa.Integer(), nullable=False, server_default='0'))
