...
from tminidb.tv_seasons.models.details import Episode
from tminidb.tv_series.models.details import Season
...
class LookupMixin(FileMixin, register=False):
    ...
    # TODO: Validate
    def show_seasons(self, tmdb_id: int) -> Sequence[Season]:
