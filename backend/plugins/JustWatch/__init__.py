...
Looks up which services carry a title and nothing else. JustWatch holds no
...
from plugins.JustWatch.sources import SourcesMixin
from plugins.utils.base_plugin.files import BaseFile


# TODO: Validate
class JustWatch(SourcesMixin, register=True):
    """JustWatch plugin."""
    ...
    def url_regex(cls) -> str:
        msg = "No URL is imported from JustWatch."
    ...
    def upsert_show(
        ...
        *,
        ...
        msg = "JustWatch stores no shows of its own."
        raise NotImplementedError(msg)
