...
from plugins.utils.base_plugin_v2.check import CheckMixin
from plugins.utils.base_plugin_v2.context import (
    PluginContext,
    plugin_context,
...
# TODO: Validate
class PluginCore(PreloadMixin, CheckMixin, URLMixin, ABC):
    session: Session
    ...
    def implements(cls, method_name: str) -> bool:
        ...
        core_implementation = inspect.getattr_static(PluginCore, method_name)
...
# TODO: Validate
class ReadURLCore(PluginCore, ABC, register=False):
    _show_key: str
