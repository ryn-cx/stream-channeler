...
ADMIN_ROUTES: list[tuple[Method, str]] = [
    ...
    ("get", "/titles/canonical"),
    ("get", f"/titles/canonical/{MISSING}"),
    ...
    ("put", f"/titles/{MISSING}/canonical-by-tmdb-url"),
    ("post", f"/titles/{MISSING}/non-canonical-by-url"),
    ("delete", f"/titles/{MISSING}/canonical/{MISSING}"),
    ("post", f"/titles/{MISSING}/canonicalize"),
