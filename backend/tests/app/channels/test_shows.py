...
from app.channels.service import shows
...
def test_a_channel_lists_every_show_on_it(
    ...
    output = shows.channel_shows_output(channel, owner, session_scoped_session)
...
def test_removing_a_show_takes_it_off_the_channel(
    ...
    shows.remove_show(session_scoped_session, channel_show)
...
def test_removing_a_show_names_it_in_the_answer(
    ...
    message = shows.remove_show(session_scoped_session, channel_show)
...
def test_adding_a_show_puts_it_on_the_channel(session_scoped_session: Session) -> None:
    ...
    shows.add_show(session_scoped_session, channel, show)
