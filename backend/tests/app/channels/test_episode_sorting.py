...
# TODO: Validate
def test_returns_all_episodes(episode_setup: EpisodeSetup) -> None:
...
# TODO: Validate
def test_respects_limit(episode_setup: EpisodeSetup) -> None:
...
# TODO: Validate
def test_ascending_air_date(episode_setup: EpisodeSetup) -> None:
    episodes = _build(
        episode_setup,
...
# TODO: Validate
def test_descending_air_date(episode_setup: EpisodeSetup) -> None:
    episodes = _build(
        episode_setup,
...
# TODO: Validate
def test_ascending_duration(episode_setup: EpisodeSetup) -> None:
    episodes = _build(
        episode_setup,
...
# TODO: Validate
def test_descending_duration(episode_setup: EpisodeSetup) -> None:
    episodes = _build(
        episode_setup,
...
# TODO: Validate
def test_last_watched_sort_ascending(episode_setup: EpisodeSetup) -> None:
...
# TODO: Validate
def test_minimum_duration(episode_setup: EpisodeSetup) -> None:
    episodes = _build(episode_setup, minimum_duration=150)
    assert all(ep.duration >= 150 for ep in episodes)  # noqa: PLR2004


# TODO: Validate
def test_maximum_duration(episode_setup: EpisodeSetup) -> None:
    episodes = _build(episode_setup, maximum_duration=150)
    assert all(ep.duration <= 150 for ep in episodes)  # noqa: PLR2004


# TODO: Validate
def test_duration_range(episode_setup: EpisodeSetup) -> None:
    episodes = _build(
        episode_setup,
        minimum_duration=50,
...
# TODO: Validate
def test_minimum_air_date_absolute(episode_setup: EpisodeSetup) -> None:
...
# TODO: Validate
def test_minimum_air_date_relative(episode_setup: EpisodeSetup) -> None:
...
# TODO: Validate
def test_multiple_sorts_applied(episode_setup: EpisodeSetup) -> None:
...
# TODO: Validate
def test_random_sort_with_limit(episode_setup: EpisodeSetup) -> None:
    episodes = _build(
        episode_setup,
        sort_by=[_sort_key("episode.random")],
        random_seed=42,
...
# TODO: Validate
def test_two_normal_sorts(episode_setup: EpisodeSetup) -> None:
    episodes = _build(
        episode_setup,
        sort_by=[
            _sort_key("show.name", "ascending"),
...
# TODO: Validate
def test_results_include_channel_id(episode_setup: EpisodeSetup) -> None:
...
def test_results_include_watch_data(episode_setup: EpisodeSetup) -> None:
    ...
    unwatched_result = next(r for r in results if r.episode.id != watched_episode.id)
