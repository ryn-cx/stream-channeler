...
# TODO: Validate
def _random_value(object_type: type) -> object:  # noqa: PLR0911 - One return per kind of type.
    ...
    # A JSON column carrying whatever a plugin put there. Nothing reads a random
    # value out of it, and a random one is what several of the readers choke on,
    # so it is left as the empty mapping the column defaults to.
    if origin is dict:
        return {}
