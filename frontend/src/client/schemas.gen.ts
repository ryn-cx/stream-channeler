...
export const ChannelAdminListOutputSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/ChannelAdminOutput'
            },
            type: 'array',
            title: 'Data'
        },
    ...
    title: 'ChannelAdminListOutput',
    description: 'Schema for returning a page of `Channel`s to an admin.'
} as const;
...
export const ChannelOrderAdminListOutputSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/ChannelOrderAdminOutput'
            },
            type: 'array',
            title: 'Data'
        },
    ...
    type: 'object',
    required: ['data', 'total_count', 'filtered_count', 'is_server_side'],
    title: 'ChannelOrderAdminListOutput',
    description: 'Schema for returning a page of `ChannelOrder`s to an admin.'
} as const;

export const ChannelOrderAdminOutputSchema = {
    properties: {
        name: {
            anyOf: [
                {
    ...
    type: 'object',
    required: ['visibility', 'config', 'id', 'user_id', 'username', 'score'],
    title: 'ChannelOrderAdminOutput',
    description: 'Schema for returning a `ChannelOrder` to an admin, including score.'
} as const;
...
export const ChannelOrderOutputSchema = {
    ...
    type: 'object',
    required: ['visibility', 'config', 'id', 'user_id'],
    title: 'ChannelOrderOutput',
    description: 'Schema for returning a `ChannelOrder`.'
} as const;

export const ChannelOrderPublicListOutputSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/ChannelOrderPublicOutput'
            },
            type: 'array',
            title: 'Data'
        },
    ...
    type: 'object',
    required: ['data', 'total_count', 'filtered_count', 'is_server_side'],
    title: 'ChannelOrderPublicListOutput',
    description: 'Schema for returning a page of publicly listed `ChannelOrder`s.'
} as const;

export const ChannelOrderPublicOutputSchema = {
    properties: {
        name: {
            anyOf: [
                {
    ...
    type: 'object',
    required: ['visibility', 'config', 'id', 'user_id', 'username'],
    title: 'ChannelOrderPublicOutput',
    description: 'Schema for returning a publicly listed `ChannelOrder`.'
} as const;
...
export const PluginListOutputSchema = {
    ...
    type: 'object',
    required: ['key', 'visibility', 'id', 'username'],
