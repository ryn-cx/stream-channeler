...
export const CreatedByItemSchema = {
    properties: {
        id: {
            anyOf: [
                {
...
export const FlatrateItemSchema = {
    properties: {
        logo_path: {
            anyOf: [
                {
...
export const LastEpisodeToAirSchema = {
    properties: {
        id: {
            anyOf: [
                {
...
export const MovieDetailsModelSchema = {
    properties: {
        adult: {
            anyOf: [
                {
    ...
    properties: {
        detail: {
            anyOf: [
                ...
                {
                    '$ref': '#/components/schemas/TvSeriesDetailsModel'
                }
            ],
            title: 'Detail'
        },
...
export const TvSeriesDetailsModelSchema = {
    properties: {
        adult: {
            anyOf: [
                {
        ...
        created_by: {
            anyOf: [
                {
                    items: {
                        '$ref': '#/components/schemas/CreatedByItem'
                    },
                    type: 'array'
                },
                {
    ...
    properties: {
        ...
        rent: {
            anyOf: [
                {
                    items: {
                        '$ref': '#/components/schemas/RentItem'
                    },
                    type: 'array'
                },
                {
        ...
        flatrate: {
            anyOf: [
                {
                    items: {
                        '$ref': '#/components/schemas/FlatrateItem'
                    },
                    type: 'array'
                },
                {
