...
export class ChannelsService {
     ...
     * @throws ApiError
     */
    public static getChannelStoreTitles(data: ChannelsGetChannelStoreTitlesData): CancelablePromise<ChannelsGetChannelStoreTitlesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/channels/{channel_id}/store-titles',
            path: {
                channel_id: data.channelId
            },
            errors: {
...
export class TitlesService {
    ...
    /**
     * Admin Get Automatic Link Groups
     * Count the titles whose every TMDB link is automatic and unverified.
     * @param data The data for the request.
     * @param data.bySource
     * @returns AutomaticLinkGroupOutput Successful Response
     * @throws ApiError
     */
    public static adminGetAutomaticLinkGroups(data: TitlesAdminGetAutomaticLinkGroupsData = {}): CancelablePromise<TitlesAdminGetAutomaticLinkGroupsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/titles/automatic-links',
            query: {
    ...
    /**
     * Admin Reset Automatic Link Group
     ...
     * @throws ApiError
     */
    public static adminResetAutomaticLinkGroup(data: TitlesAdminResetAutomaticLinkGroupData): CancelablePromise<TitlesAdminResetAutomaticLinkGroupResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/titles/automatic-links/{group_id}/reset',
            path: {
...
export class VideoStoreService {
     ...
     * @returns VideoStoreLanguageOutput Successful Response
     * @throws ApiError
     */
    public static getOriginalLanguages(): CancelablePromise<VideoStoreGetOriginalLanguagesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/video-store/original-languages'
        });
    }
     ...
     * @throws ApiError
     */
    public static getSpokenLanguages(): CancelablePromise<VideoStoreGetSpokenLanguagesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/video-store/spoken-languages'
        });
    }
     ...
     * @throws ApiError
     */
    public static getTitleDetail(data: VideoStoreGetTitleDetailData): CancelablePromise<VideoStoreGetTitleDetailResponse> {
        return __request(OpenAPI, {
            method: 'GET',
