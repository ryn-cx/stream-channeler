...
export class PluginsService {
     ...
     * @throws ApiError
     */
    public static tmdbMatch(data: PluginsTmdbMatchData): CancelablePromise<PluginsTmdbMatchResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/plugins/tmdb/match',
            query: {
                title: data.title,
                media_type: data.mediaType,
                year: data.year
     ...
     * @throws ApiError
     */
    public static tmdbMediaInfo(data: PluginsTmdbMediaInfoData): CancelablePromise<PluginsTmdbMediaInfoResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/plugins/tmdb/media-info',
            query: {
                media_type: data.mediaType,
                tmdb_id: data.tmdbId
            },
