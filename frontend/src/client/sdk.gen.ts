...
export class EpisodesService {
     ...
     * @throws ApiError
     */
    public static getEpisodeDatabaseRows(data: EpisodesGetEpisodeDatabaseRowsData): CancelablePromise<EpisodesGetEpisodeDatabaseRowsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
