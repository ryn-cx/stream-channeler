...
export class PluginsService {
     ...
     * @throws ApiError
     */
    public static manualSearchUrl(data: PluginsManualSearchUrlData): CancelablePromise<PluginsManualSearchUrlResponse> {
        return __request(OpenAPI, {
            method: 'GET',
