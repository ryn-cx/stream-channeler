...
export type MovieDetailsModel = {
    adult?: (boolean | null);
    backdrop_path?: (string | null);
    belongs_to_collection?: (unknown | BelongsToCollection | null);
    budget?: (number | null);
    ...
    poster_path?: (string | null);
    production_companies?: (Array<ProductionCompany> | null);
    production_countries?: (Array<ProductionCountry> | null);
    release_date?: (string | null);
    revenue?: (number | null);
    runtime?: (number | null);
    softcore?: (boolean | null);
    spoken_languages?: (Array<SpokenLanguage> | null);
    status?: (string | null);
    tagline?: (string | null);
    title?: (string | null);
    video?: (boolean | null);
...
export type TMDBMediaInfo = {
    ...
    watch_providers?: (tminidb__movie__watch_providers__optional_models__Us | tminidb__tv_series__watch_providers__optional_models__Us | null);
};

export type tminidb__movie__watch_providers__optional_models__Us = {
    link?: (string | null);
    ads?: (Array<Ad> | null);
    rent?: (Array<RentItem> | null);
    flatrate?: (Array<FlatrateItem> | null);
    buy?: (Array<BuyItem> | null);
    free?: (Array<FreeItem> | null);
};
...
export type TvSeriesDetailsModel = {
    adult?: (boolean | null);
    backdrop_path?: (string | null);
    created_by?: (Array<CreatedByItem> | null);
